 ...
 * taxonomy.php
 * 
 * Ce fichier est le modèle utilisé pour les pages d'archives des taxonomies personnalisées.
 * Il est utilisé pour afficher les contenus du CPT 'Games' appartenant à une console spécifique ou une année spécifique.
 */
