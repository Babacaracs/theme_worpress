 ...
 * archive.php
 * 
 * Ce fichier est le modèle utilisé pour les pages d'archives.
 * Il est utilisé pour afficher les articles par catégories, étiquette, date, auteur.
 * 
 * Dans notre exemple, la seule différence avec index.php est que ce template appelle content-excerpt.php au lieu de content.php pour afficher le contenu de l'article.
 * Même dans content-excerpt.php, la seule différence avec content.php est qu'on affiche l'extrait de l'article seulement.
 * 
 * Donc, on aurait simplement pu ne pas inclure ce template et laisser WordPress utiliser index.php pour les archives, 
 ...
 * Ce template est donc juste inclus pour l'exemple mais je recommande dans tous les cas d'inclure un archive.php dans chaque thème.
 * 
 * Aussi, jetez un oeil à header.php pour voir comment est géré l'affichage du titre de la page d'archives.
 */
